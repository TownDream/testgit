class CanvasManager {
    ...
    constructor(canvasBoxId) {
        ...
        this.canvasBox = document.getElementById(canvasBoxId);
    ...
    static htmlInit(canvasBoxId) {
        ...
        canvasBox.style.width = (document.documentElement.clientWidth - 25) + "px";
        canvasBox.style.height = (document.documentElement.clientHeight - 25) + "px";
        //创建画布 以及 功能点击栏
        canvasBox.innerHTML = "" +
            "<style>\n" +
            "    #functionsBox {\n" +
    ...
    // 样式初始化
    styleInit() {
        console.log("box "+this.canvasBox.clientHeight);
        ...
        this.nCanvas.width = this.canvasBox.offsetWidth;
        this.nCanvas.height = this.canvasBox.offsetHeight;
